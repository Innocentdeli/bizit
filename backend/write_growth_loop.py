GROWTH_LOOP_PY = r'''from fastapi import APIRouter, Depends
...
with open('routers/growth_loop.py', 'w', encoding='utf-8', newline='\n') as f:
    f.write(GROWTH_LOOP_PY.strip())
print('growth_loop.py written')
